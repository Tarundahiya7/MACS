  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid gap-6">
        {showBaselineOnly && (
          <>
            <SingleCPUChart series={baseSeries} title="Baseline CPU Utilization" color="#FFA500" />
        ...
        {showMemoryOnly && (
          <>
            <SingleCPUChart series={marrSeries} title="Memory-Aware CPU Utilization" color="#2ECC71" />
